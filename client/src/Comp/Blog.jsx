...
const Blog = () => {
    ...
    const options = [
      ...
      async function Load() {
        ...
        const result = await axios.get("https://localhost:7154/api/News/Getnews");
      ...
      async function save(event) {
        ...
        try {
          await axios.post("https://localhost:7154/api/News/BlogRemarks", {
    ...
    const handlesearch=(event)=>{
        ...
        <div className="nav-item dropdown">
          ...
          <div className="dropdown-menu m-0">
            ...
            <a href="/Blog2" className="dropdown-item">Taxila</a>
